...
<ul class="navbar-nav sidebar sidebar-dark accordion bg-gray-900"  id="accordionSidebar">
  ...
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url("UserPage/index")?>">
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url("UserPage/index"); ?>">
