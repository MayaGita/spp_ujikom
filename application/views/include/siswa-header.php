...
<body id="page-top">
    ...
    <div class="sidebar">
         ...
         <div class="sidebar-menu">
           ...
           <ul>
             <li>
               <a href="<?= site_url('siswa/index')?>" class="active"><span class="fas fa-columns"></span>
                <span>Dashboard</span>
              </a>
             </li>
                <hr>
              ...
              <li>
               <a href="<?= site_url('siswa/profile')?>"><span class="fas fa-money-check-alt"></span>
                <span>Siswa profile</span>
              </a>
             </li>
             <hr>
              <li>
               <a href="<?= site_url('siswa/History')?>"><span class="fas fa-history"></span>
