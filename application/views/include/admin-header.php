...
<head>
  ...
  <link href="<?= base_url('plugin/')?>datepicker/dist/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css">
...
<ul class="navbar-nav sidebar sidebar-dark accordion bg-gray-900"  id="accordionSidebar">
  ...
  <div class="sb-sidenav-menu-heading text-gray-700 pl-3">Data</div>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url("kelas/index"); ?>">
      <i class="fas fa-fw fa-chart-area"></i>
      <span>Data kelas</span></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url("spp/index"); ?>">
      <i class="fas fa-fw fa-chart-area"></i>
...
<!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
  <a class="nav-link" href="<?php echo site_url("entry/index"); ?>">
  ...
  <a class="nav-link" href="<?php echo site_url("history/history"); ?>">
    ...
    <li class="nav-item">
  <a class="nav-link" href="<?php echo site_url("entry/isiLaporan"); ?>">
