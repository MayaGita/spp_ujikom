              ...
              <h6 class="m-0 font-weight-bold ">pembayaran</h6>
                ...
                <?php echo form_open_multipart('entry/insert');?>
                  ...
                  <div class="form-row pt-5 text-center mx-5 ">
                    ...
                    value="<?php  date_default_timezone_set('Asia/Jakarta'); echo date('Y-m-d H:i:s');?>">
                     ...
                     <div class="form-group col-md-8 text-center">
                       ...
                       <div class="form-group col-md-6">
                    <input type="text" id="disabledInput" class="form-control form-control-sm text-center" name='tahun_dibayar'  value="<?php echo date('Y');?>">
                  ...
                  <div class="form-row mt-5 text-center mx-5">
                    ...
                    <input type="text" id="julah_bayar" class="form-control form-control-sm text-uppercase text-center" name='jumlah_bayar' placeholder='masukan jumlah bayar'>
                     </div>
                  </div>
